        ...
        <div class="login-box main-content">
            <header>
                <ul class="action-buttons clearfix fr">
                    ...
                    <li><a href="#" class="button button-gray"><span class="help"></span>Help</a></li>
                </ul>
                <h2>Data Dictionary</h2>
            </header>
            <section>
                <div class="message notice">Input your credentials to use system</div>
                <form id="form" action="process.php?action=login" method="post" class="clearfix">
                    <p>
                        ...
                        <button class="large button button-blue fr" type="submit">Login</button>
                    </p>
                    <p class="clearfix">
                        <span class="fl">
                            <input type="checkbox" id="remember" class="" value="1" name="remember"/>
                            <label class="choice" for="remember">Keep me logged</label>
                        </span>
                    </p>
                </form>
            </section>
