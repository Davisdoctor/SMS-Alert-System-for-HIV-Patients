                        ...
                        <div class="main-content grid_8 alpha">
                            ...
                            <div class="main-content grid_4 alpha">
                                <section class="clearfix">
                                    <form class="form" method="POST" action="process.php?action=new_review" >
                                        <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            <label>Date scheduled <em>*</em></label>
                                            <input type="date" name="date_scheduled" required="required" />
                                        </div>
                                        <div class="clearfix">
                                            <label>Next view date <em>*</em></label>
                                            <input type="date" name="next_view_date" required="required" />
                                        </div>
                                        <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            <label>Function at status <em>*</em></label>
                                            <input type="text" name="function_at_status" required="required" />
                                        </div>

                                        <div class="clearfix">
                                            <label>Who clinical stage <em>*</em></label>
                                            <input type="text" name="who_clinical_stage" required="required" />
                                        </div>

                                        <div class="clearfix">
                                            <label>Ceptrine <em>*</em></label>
                                            <input type="text" name="ceptrine" required="required" />
                                        </div>
                                        <div class="clearfix">
                                            <label>Adherence <em>*</em></label>
                                            <input type="text" name="adherence" required="required" />
                                        </div>
                                        <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            <label>Dosage <em>*</em></label>
                                            <input type="text" name="dosage" required="required" />
                                        </div>
                                        <div class="clearfix">
                                            <label>VL <em>*</em></label>
                                            <input type="text" name="vl" required="required" />
                                        </div>
                                        <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            <label>Doctor Initials <em>*</em></label>
                                            <input type="text" name="doctor_initials" required="required" />
                                        </div>
