                                ...
                                <tbody>
                                    ...
                                    while ($row = mysql_fetch_assoc($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="process.php?action=edit_patient.php" method="POST">
                                                    <input type="hidden" name="patient_id" value="<?php echo $row['Patient_Id'] ?>">
                                                    <input type="submit" class="button button-blue" value="Edit">
                                                </form>
                                            </td>
                                            <td>
                                                <form action="process.php?action=delete_patient" method="POST">
                                                    <input type="hidden" name="patient_id" value="<?php echo $row['Patient_Id'] ?>">
