                        ...
                        <div class="main-content grid_8 alpha">
                            ...
                            <div class="main-content grid_4 alpha">
                                <section class="clearfix">
                                    <form class="form" method="POST" action="process.php?action=new_viral_load" >
                                        <div class="clearfix">
                                            <label>Viral Load <em>*</em></label>
                                            &nbsp;&nbsp;
                                        ...
                                        <div class="clearfix">
                                            <label>VL Numbers <em>*</em></label>
                                            <input type="text" name="vl_numbers" required="required" />
                                        </div>
                                        <div class="clearfix">
                                            <label>Date Sample drawn <em>*</em></label>
                                            <input type="date" name="date_sample_drawn" required="required" />
                                        </div>
                                        <div class="clearfix">
                                            <label>Date Sample returned <em>*</em></label>
                                            <input type="date" name="date_sample_returned" required="required" />
                                        </div>
